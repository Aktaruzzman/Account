                            ...
                            <table class="w3-table-all w3-border-0" id="clientTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="report-line {{#if deleted_at}}w3-red{{/if}}">
                                        ...
                                        <td class="w3-padding-small w3-cursor-pointer"><a href="<?php echo site_url('office/api/token/{{app_id}}') ?>">{{app_id}}</a></td>
                                        <td class="w3-padding-small w3-center">{{phone}}</td>
                                        <td class="w3-padding-small">{{email}}</td>
                                        <td class="w3-padding-small w3-center"><a href="<?php echo site_url('office/shop/index/{{id}}') ?>"><i class="fa fa-university w3-text-theme"></i></a></td>
