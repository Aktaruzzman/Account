                            ...
                            <table class="w3-table-all w3-border-0" id="clientTable">
                                ...
                                <thead class="w3-text-bold w3-theme-light">
                                    ...
                                    <tr class="w3-theme-light w3-text-bold">
                                        ...
                                        <th class="w3-padding-small w3-text-capitalize w3-center w3-hide-small w3-hide-medium">Stated From</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {{#each list}}
                                    <tr class="report-line">
                                        ...
                                        <td class="w3-padding-small w3-center"><a class="w3-border-bottom w3-border-theme" href="<?php echo site_url('office/api/token/{{client_id}}') ?>"><i class="fa fa-code w3-text-theme w3-text-bold">&nbsp; Key</i></a></td>
