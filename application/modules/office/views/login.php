<div class="content-area top-mutual" id="contentArea">
    <div class="w3-content w3-container">
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-col l6 m6 w3-s12 w3-section w3-padding-48">
                <div class="w3-theme-light w3-round w3-border-theme w3-border">
                    <div class="w3-xlarge w3-border-bottom w3-border-theme w3-text-theme">
                        <div class="w3-text-bold my-font w3-container"><?php echo lang('login') ?></div>
                    </div>
                    <?php echo form_open(site_url('office/login'), array('method' => 'post', 'id' => 'officerLoginForm', 'class' => 'w3-container', 'autocomplete' => 'off')) ?>
                    ...
                    <div class="form-group">
                        <label class="w3-text-capitalize"><?php echo $this->lang->line('username') ?></label>
