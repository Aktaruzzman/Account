                        ...
                        <table class="w3-table-all w3-border-0" id="shopTable">
                            ...
                            <tbody>
                                ...
                                <tr class="report-line">
                                    ...
                                    <td class="w3-padding-small w3-center"><a href="<?php echo site_url('shop/service/' . $client . '/{{id}}') ?>"><i class="fa fa-wrench"></i></a></td>
                                    <td class="w3-padding-small w3-center"><a href="<?php echo site_url('shop/app/' . $client . '/{{id}}') ?>"><i class="fa fa-windows"></i></a></td>
                                    ...
                                    <td class="w3-padding-small w3-center"><a href="<?php echo site_url('api/token/{{api}}') ?>">{{api}}</a></td>
